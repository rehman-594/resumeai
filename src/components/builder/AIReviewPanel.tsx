                ...
                <div className="p-6 flex-1 overflow-y-auto">
                  {!reviewResult && !isGenerating ? (
                    ...
                    <div className="space-y-4">
                      <div className="prose prose-invert prose-emerald max-w-none text-zinc-300 text-sm leading-relaxed 
                                      prose-headings:text-emerald-400 prose-headings:font-bold prose-headings:mb-2 prose-headings:mt-4
                                      prose-strong:text-white prose-p:mb-2 prose-ul:list-disc prose-ul:pl-4 prose-li:mb-1">
